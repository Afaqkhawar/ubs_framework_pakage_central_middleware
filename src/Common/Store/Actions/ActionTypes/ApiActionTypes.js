...
export const GET_TASK_MANAGEMENT_DASHBOARD_DATA= 'GET_TASK_MANAGEMENT_DASHBOARD_DATA';
export const GET_GRAPH_DATA= 'GET_GRAPH_DATA';
export const GET_TASK_PERFORMANCE_GRAPH_DATA= 'GET_TASK_PERFORMANCE_GRAPH_DATA';
export const GET_COMMENTS_DATA='GET_COMMENTS_DATA';
export const API_DOCUMENTATION = "API_DOCUMENTATION";

export const GET_MAIN_ADMIN_DASHBOARD_DATA = 'GET_MAIN_ADMIN_DASHBOARD_DATA';
export const GET_SCRUTINIZER_DASHBOARD_DATA = 'GET_SCRUTINIZER_DASHBOARD_DATA';
export const GET_TEST_SCHEDULER_DASHBOARD_DATA = 'GET_TEST_SCHEDULER_DASHBOARD_DATA';
export const GET_ADMISSION_DASHBOARD_DATA = 'GET_ADMISSION_DASHBOARD_DATA';
export const GET_BACHELORS_LIST = 'GET_BACHELORS_LIST';

export const ADMIN_VIEW_USER ='ADMIN_VIEW_USER';
